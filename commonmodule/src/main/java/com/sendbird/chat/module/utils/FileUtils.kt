...
object FileUtils {
    ...
    fun selectFile(type: String, startForResult: ActivityResultLauncher<Intent>, context: Context)
    {
...
//        ) {
//            requestStoragePermission(startForResult,context)
//        } else {
...
//        } else {
    ...
    private fun requestStoragePermission(startForResult: ActivityResultLauncher<Intent>,context: Context) {
